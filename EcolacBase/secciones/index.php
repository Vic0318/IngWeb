...
<body>
   ...
   <div> <button class="menu-toggle" onclick="toggleSidebar()">☰</button></div>
    <section class="titulosPage">
        <h2>
            <?php
            // Verifica si el usuario ha iniciado sesión y tiene un nombre de usuario almacenado en la sesión
        ...
        <hr>
        <h5><a>En este espacio podrá ingresar su queja sobre los productos recibidos<a></h5><br>
            <a>Navegue por el menú lateral donde uster como distribuidor podrá en la sección "Devoluciones" dar su queja
                del o los productos recibidos, solo ingrese el producto, la cantidad que desea devolver y la razón por la
                que devuelve esto nos servirá mucho para mejorar su experiencia.</a>
        <h5><br>Le Agradece Ecolac.<h5>
    </section>
