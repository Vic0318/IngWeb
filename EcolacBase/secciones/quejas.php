...
if ($accion != '') {
    switch ($accion) {
        case 'agregar':
            $sql = "INSERT INTO `quejas` (`id`, `fecha`, `producto`, `uMedida`, `caducado`, `mal_sellado`, `presentacion`, `contaminado`, `cantidad`, `observaciones`, `autor`)
        VALUES (NULL, :fecha, :producto, :uMedida, :caducado, :mal_sellado, :presentacion, :contaminado, :cantidad, :observaciones, :autor)";
        ...
        case "Seleccionar":
            ...
            $cantidad = $quejas['cantidad'];
            $observaciones = $quejas['observaciones'];
            $autor = $quejas['autor'];
            break;
